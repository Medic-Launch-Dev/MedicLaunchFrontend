...
export default function PlanOption({ name, price, mostPopular, selected, setSelected }: PlanOptionProps) {
  ...
  const checkIcon = (
    <svg width="22" height="22" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M9.36966 18.2286C14.2909 18.2286 18.2803 14.2391 18.2803 9.31791C18.2803 4.39667 14.2909 0.407227 9.36966 0.407227C4.44843 0.407227 0.458984 4.39667 0.458984 9.31791C0.458984 14.2391 4.44843 18.2286 9.36966 18.2286ZM9.25679 11.5768L12.713 8.01253L11.7289 7.0582L8.74541 10.1349L6.99074 8.46461L6.04554 9.45754L8.29212 11.5961L8.78401 12.0644L9.25679 11.5768Z" fill="url(#paint0_linear_2098_2574)" />
      <defs>
        <linearGradient id="paint0_linear_2098_2574" x1="0.458984" y1="0.933967" x2="21.701" y2="11.0349" gradientUnits="userSpaceOnUse">
          <stop offset="0.0532222" stop-color="#2496C7" />
